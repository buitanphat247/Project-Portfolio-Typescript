  ...
  experience: [
    {
      ...
      description: "Phát triển các ứng dụng web và mobile cho khách hàng. Tối ưu hóa hiệu suất và kiến trúc hệ thống. Làm việc với nhiều công nghệ khác nhau.",
    ...
    },
    {
      ...
      duration: "2022 - 2023",
      description: "Lãnh đạo team phát triển các dự án học tập. Áp dụng kiến thức về thuật toán và cấu trúc dữ liệu vào thực tế.",
    ...
    },
    {
      ...
      duration: "2021 - 2022",
      description: "Xây dựng các dự án cá nhân để học hỏi và phát triển kỹ năng. Tập trung vào UI/UX và responsive design.",
