      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
           ...
           <div className="flex items-center">
                           <h1 className="text-xl font-bold !text-white" style={{ color: 'white' }}>{name}</h1>
              <span className="ml-2 text-sm !text-white hidden sm:block" style={{ color: 'white' }}>({title})</span>
           </div>
           ...
           <nav className="hidden md:flex space-x-6">
             {navItems.map((item) => (
                  ...
                  className="text-white !text-white hover:text-purple-400 px-3 py-2 text-sm font-medium transition-all duration-200 cursor-pointer relative group"
                  style={{ color: 'white' }}
                >
                  {item.label}
