        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
          ...
          <div>
            ...
            <div className="space-y-3 text-base">
              ...
              >
                <div className="w-10 h-10 bg-gray-900 rounded-lg flex items-center justify-center group-hover:bg-cyan-500/20 transition-colors">
                  <i className="fa-solid fa-envelope text-cyan-400"></i>
                </div>
                <span>{profileConfig.contact.email}</span>
              </a>
              <a 
            ...
            <div className="flex gap-3">
              {profileConfig.socialLinks.github && (
                <a
                  ...
                  className="w-12 h-12 bg-gray-900 rounded-lg flex items-center justify-center hover:bg-gray-800 border border-gray-800 hover:border-cyan-500/50 transition-all duration-200 cursor-pointer"
                  aria-label="GitHub"
                >
                  <i className="fa-brands fa-github text-gray-300 hover:text-cyan-400 text-xl transition-colors"></i>
                </a>
              )}
